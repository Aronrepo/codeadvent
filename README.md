...
Advent of Code is an annual event that takes place every December, inviting participants from around the globe to solve a series of coding puzzles throughout the month. Created by Eric Wastl, each day leading up to Christmas, a new set of challenges is released, ranging in difficulty and covering a wide array of programming concepts and problem-solving techniques.
...
[Puzzle input](dist/03/input3.txt)
...
[Puzzle input](dist/04/input4.txt)
